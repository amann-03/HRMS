...
<div id="content">
    ...
    <h3>Add Employees to Project</h3>
            <form action="Hr_Project1.php" method="POST">
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["create_button"])) {
        ...
        if($run_query){
            header("location:http://localhost/personal/HRMS07/HRMS-master/hr_project1.php"); // if data successfully saved.
            exit();
        } else {
            header("location:http://localhost/personal/HRMS07/HRMS-master/hr_project1.php"); // if data not saved.
            exit();
        }
    }
?>
