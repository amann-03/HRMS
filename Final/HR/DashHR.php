...
<div class="row" style="display:inline-flex; width: 84vw;">
 ...
 <?php if(isset($_POST['create'])){ 
      ...
      $ins = "INSERT INTO `meeting_project`(`meeting_url`, `host`, `agenda`, `meet_time`, `meet_proj_id`, `duration`) VALUES ('".$url."', ".$_SESSION['employee_id'].", '".$agenda."', '".$dt."', ".$proj.", ".$dur." )";
...
<ul >
 ...
 <?php if(isset($_POST['notice'])){ 
  ...
  $hr8 = "INSERT INTO `notices`(`notice_creator`, `content`, `notice_time`, `title`) VALUES (".$_SESSION['employee_id'].", '".$content."', '".$dt."', '".$title."')";
 ...
 <div class="card-body">
    ...
    <?php 
        ...
        $stat = "SELECT notice_creator, notice_time, content, title, name from notices join employee on employee.employee_id = notices.notice_creator order by notice_time desc";
 ...
 <ul class="list-group" id="dashboardlist">
          ...
          <a class='not' dataid="<?php echo $row->content; ?>" dtile="<?php echo $row->title; ?>" dtime ="<?php echo date('H:i', strtotime($row->notice_time)); ?>" data-bs-toggle="modal" data-bs-target="#myModal" style="border: 0px; cursor: pointer;"><li class="bar-list" style="cursor:pointer;height: 6vh; "><div class="notice"><?php  echo $row->title; ?></div>
