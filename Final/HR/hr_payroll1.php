<?php  require_once('C:\xampp\htdocs\hrms\config.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
if ($result) {
    ...
    echo "Total budget of all departments<br><br>". number_format($totalbudget, 2, '.', '')." $";
}
...
if ($result) {
    $row = $result->fetch_assoc();
    $totalbudget = $row['totalbudget'];
    echo "Total budget of all projects<br><br>" . number_format($totalbudget, 2, '.', '')." $";
}
...
if ($result) {
    ...
    echo "Average budget of all projects<br><br>" . number_format($averagebudget, 2, '.', '')." $";
}
...
if ($result) {
    ...
    $averagebudget=$totalbudget/$row_count;
    echo "Average budget of all departments<br><br>" . number_format($averagebudget, 2, '.', '')." $";
}
...
if ($result) {
    ...
    $averagebudget=$totalbudget/$row_count;
    echo "Average salary of all employees<br><br>".number_format($averagebudget, 2, '.', '')." $";
}
...
<div id="box9">
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Budget allocated to different projects (in $)',
                data: <?php echo $budgetsJS; ?>,
                borderWidth: 1
            }]
        },
