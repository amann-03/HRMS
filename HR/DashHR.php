...
<div class="row" style="display:inline-flex; width: 84vw;">
 ...
 <ul class="list-group" id="dashboardlist">
			...
			<a><li class="bar-list">Meeting Agenda<div class="gu1">date time</div></a></li><a><div style="height: 0px;"class="item1">completed</div></a>
		<?php } ?><?php for($x=0;$x<3;$x++) {?>

      <a><li class="bar-list">Meeting<div class="gu1">date time</div></a></li><a><div class="item1"style="height: 0px;">start</div></a>
    <?php } ?>
         </ul>
         </div>
...
<ul >
 ...
 <ul class="list-group" >
			...
			<a class='not' data="notice"><li class="bar-list" style="cursor:pointer;height: 6vh; "><div class="notice">Notice</div><div class="min">date time</div> <div class="min notice">Creator bhai</div> </li></a>
		<?php } ?>

  <?php for($x=0;$x<2;$x++) {?>

      <a class='not' data="notice"><li class="bar-list" style=" cursor:pointer;height:6vh "><div class="notice">something quite big</div> <div class="min">date time</div><div class="min notice">Ctor</div> </li></a>
    <?php } ?>
...
<div class="row">
      ...
      <div>
       ...
       <a><li class="bar-list" style="height:6vh "><div class="notice">Employee ka naam</div> <div class="min">kya kaa am karta be tu</div></li></a>
    <?php } ?>
         </ul>
      </div>
			</div>
